...
namespace backend\modules\ce\classes;
 ...
 * @author appxq
 */
class EcWidget extends \backend\modules\ezforms2\classes\WidgetBuilder {
    ...
    public static function ui() {
        return Yii::createObject(EcWidget::className()); //, [get_called_class()]
    }
    ...
    protected function buildUi() {
        ...
        $url = Url::to(['/ce/default/' . $this->action,
