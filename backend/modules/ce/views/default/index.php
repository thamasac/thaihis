...
appxq\sdii\widgets\GridView::widget([
    'id' => "$reloadDiv-category-grid",
    'panelBtn' => Html::button(Yii::t('app', 'New'), [
        'class' => 'btn btn-success ezform-main-open',
        'data-modal' => $modal,
        'data-url' => Url::to([
            '/ce/default/get-form',
            'ezf_id_cat' => $ezf_id_cat,
            'ezf_id_subcat' => $ezf_id_cat,
...
$('#$reloadDiv-category-grid tbody tr td a').on('click', function() {
...
$('#$reloadDiv-category-grid').on('beforeFilter', function(e) {
...
$('#$reloadDiv-category-grid .pagination a').on('click', function() {
    getUiAjax($(this).attr('href'), '$reloadDiv');
    return false;
});

$('#$reloadDiv-category-grid thead tr th a').on('click', function() {
    getUiAjax($(this).attr('href'), '$reloadDiv');
    return false;
});
