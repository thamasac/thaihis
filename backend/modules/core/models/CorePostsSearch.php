...
/**
 * CorePostsSearch represents the model behind the search form about `backend\modules\core\models\CorePosts`.
 */
class CorePostsSearch extends CorePosts
{
    /**
     * @inheritdoc
     */
