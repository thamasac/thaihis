...
<div class="col-md-7 sdbox-col">
  ...
  <?php if (!empty($visit_type)) : ?>
      ...
      <!----------- start order ----------->
      <?= Yii::$app->controller->renderAjax('@backend/modules/patient/views/order/_ordermain', ['ezf_id' => \backend\modules\patient\Module::$formID['order_tran'], 'target' => $action_id, 'modal' => 'modal-ezform-main', 'visit_type' => $visit_type, 'pt_id' => $pt_id]); ?>
      <!----------- end order ----------->
