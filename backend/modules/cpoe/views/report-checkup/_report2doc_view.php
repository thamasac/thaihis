...
$url = \yii\helpers\Url::to(['/cpoe/report-checkup/report-to-doc-view', 'visit_id' => $visit_id, 'pt_id' => $data[0]['ptid']]);
?>

<div class="col-md-6">
  <form action="<?= $url ?>" method="post" id="form-doc-lists">
      <?php
//      $doc_lists = \yii\helpers\ArrayHelper::map($doc_lists, 'user_id', 'fullname');
//
