...
$urlReport = Url::to(['/cpoe/report-checkup-send/print-report', 'visit_id' => $data['visit_id'], 'pt_hn' => $data['pt_hn']]);
...
$urlSaveReport = Url::to(['/cpoe/report-checkup/report-save-approve', 'report_status' => '2', 'report_id' => $data['report_id']]);
$urlNextPt = Url::to(['/cpoe/report-checkup/next-pt', 'dataid' => $data['report_id']]);
