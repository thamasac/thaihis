...
<section id="items-side" class="items-sidebar navbar-collapse collapse" role="complementary" style="margin-left: 45px;width: 220px;">
  ...
  <div id="items-side-scroll" class="row">
    <div class="col-md-12" id="que-list-view">            
        <?php echo CpoeHelper::uiQueReportCheckup($pt_id, $report_status, '', 'que-items', 'r2d'); ?>
    </div>
  </div>
</section>
...
$urlQue = Url::to(['/cpoe/report-checkup/que-view-r2d', 'report_status' => $report_status, 'reloadDiv' => 'que-items']);

$url = Url::to(['/cpoe/report-checkup/report-to-doc-view']);
