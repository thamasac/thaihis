 ...
 * @author appxq
 */
class SideMenuBuilder extends Component {
    ...
    /**
     * @inheritdoc
     * @return SideMenuBuilder the newly created [[SideMenuBuilder]] instance.
     */
    public static function contentDisplay() {
        return Yii::createObject(SideMenuBuilder::className());//, [get_called_class()]
    }
    ...
    public function buildMenu() {
       if(empty($this->reloadDiv)){
        ...
        $url = Url::to(['/ezforms2/ezform-data/sidemenu',
                    'sql_id' => $this->sql_id,
    ...
    public function buildDropDown() {
       if(empty($this->reloadDiv)){
        ...
        $url = Url::to(['/ezforms2/ezform-data/target-sql',
                    'sql_id' => $this->sql_id,
                    'reloadDiv' => $this->reloadDiv,
                    'target' => $this->target,
                    'placeholder' => $this->placeholder,
