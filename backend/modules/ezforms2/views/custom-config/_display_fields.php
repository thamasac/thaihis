...
function tableFields(ezf_id){
    let value = '$select';
    $.post('". \yii\helpers\Url::to(['/ezforms2/target/table-fields'])."',{ ezf_id: ezf_id, multiple:0, allform:1, name: '{$name}[{$index_id}][select]', value: value ,id:'select-$index_id'}
