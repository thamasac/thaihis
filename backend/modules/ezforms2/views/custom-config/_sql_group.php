...
<?php if($header==1): ?>
<div class="row" >
  <div class="col-md-6 "><label>Group By</label></div>
...
<?php
$this->registerJs("
ezf_group_items = getDependAll(); 
tableFields(ezf_group_items);  

function tableFields(ezf_id){
    let value = '$group';
    $.post('". \yii\helpers\Url::to(['/ezforms2/target/table-fields'])."',{ ezf_id: ezf_id, multiple:0, name: '{$name}[{$index_id}][group]', value: value ,id:'group-$index_id'}
