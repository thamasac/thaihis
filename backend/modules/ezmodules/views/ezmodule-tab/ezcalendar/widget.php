...
$view_menu = isset($view_menu)?\backend\modules\ezforms2\classes\EzfFunc::arrayEncode2String($view_menu):\backend\modules\ezforms2\classes\EzfFunc::arrayEncode2String(['month', 'agendaWeek', 'agendaDay']);
