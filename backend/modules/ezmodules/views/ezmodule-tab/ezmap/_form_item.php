...
<div id="<?=$key_form?>" class="row form-fields dads-children" data-id="<?=$key_form?>" style="margin-bottom: 15px;">
  <div class="col-md-3 " style="padding-top: 10px;">
    ...
    <div class="col-md-3 sdbox-col" style="padding-top: 10px;"><input type="text" class="form-control label-input" name="options[params][forms][<?=$key_form?>][label]" value="" placeholder="label"></div>
    ...
    <div class="col-md-2 sdbox-col" style="margin-top: 15px; padding-bottom: 10px;">
        <div class="input-group">
            <?=  Html::textInput("options[params][forms][$key_form][color]", 'red', ['class'=>'form-control input-color', 'id'=>'specific-color-'.$key_form])?>
        </div>
    </div>
    <div class="col-md-2 sdbox-col" style="margin-top: 15px;"><?= Html::checkbox("options[params][forms][$key_form][show]", true, ['label'=>'Show'])?></div>
    <div class="col-md-2 sdbox-col" style="margin-top: 15px;"><?= Html::checkbox("options[params][forms][$key_form][conddate]", true, ['label'=>'By Date'])?></div>
    <div class="col-md-2 sdbox-col" style="margin-top: 15px;"><?= Html::checkbox("options[params][forms][$key_form][adddata]", true, ['label'=>'Edit Data'])?></div>
</div>
<?php  $this->registerJs("
var color_options = {
    showInput: true,
