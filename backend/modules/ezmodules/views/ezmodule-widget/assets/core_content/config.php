...
<div class="form-group row">
  ...
  <div class="col-md-6 sdbox-col" >
        <?= Html::label(Yii::t('ezform', 'Actions'), 'options[action]', ['class' => 'control-label']) ?>
...
<div class="form-group row">
    <div class="col-md-6">
        <?= Html::label(Yii::t('ezform', 'Content Displaying format'), 'options[display]', ['class' => 'control-label']) ?>
        <?= kartik\select2\Select2::widget([
        'id'=>'config_display',
...
<div class="form-group row">
    ...
    <div class="col-md-6 " >
      ...
      <?= yii\bootstrap\Html::hiddenInput('options[initdata]', 0)?>
        <?= \backend\modules\ezforms2\classes\EzformWidget::checkbox('options[initdata]', (isset($options['initdata'])?$options['initdata']:0), ['label'=>'Initiated by last record'])?>
...
<div class="form-group">
  <?='<div class="alert alert-info" role="alert"> 
    ...
    <?= Html::label(Yii::t('ezform', 'Content Template').' <span class="btn btn-xs btn-info btn-mini">Mini Content</span>
...
<div class="form-group">
    <?= Html::label(Yii::t('ezform', 'Box Template').' <span class="btn btn-xs btn-info btn-card">Card</span> <span class="btn btn-xs btn-info btn-panel">Panel</span>', 'options[template_box]', ['class' => 'control-label']) ?>
   <?= appxq\sdii\widgets\FroalaEditorWidget::widget([
