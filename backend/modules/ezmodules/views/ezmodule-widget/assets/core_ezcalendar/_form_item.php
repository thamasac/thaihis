...
<div id="<?=$key_form?>" class="row form-fields dads-children" data-id="<?=$key_form?>" style="margin-bottom: 15px;">
  <div class="col-md-3 " style="padding-top: 10px;">
    ...
    <div class="col-md-3 " style="padding-top: 10px;"><input type="text" class="form-control label-input" name="options[forms][<?=$key_form?>][label]" value="" placeholder="label"></div>
                             
    <div class="col-md-1 sdbox-col" style="margin-top: 15px; padding-bottom: 10px;">
        <div class="input-group">
            <?=  Html::textInput("options[forms][$key_form][color]", '#3a87ad', ['class'=>'form-control input-color', 'id'=>'specific-color-'.$key_form])?>
        </div>
    </div>
    ...
    <div class="col-md-2 sdbox-col" style="margin-top: 15px;"><?= Html::checkbox("options[forms][$key_form][editable]", true, ['label'=>'Edit Data'])?></div>
</div>
<?php  $this->registerJs("
var color_options = {
    showInput: true,
