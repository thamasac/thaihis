...
<div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-md-3 sdbox-col">
        <?= Html::label(Yii::t('ezform', 'Column'), 'options[class_css]', ['class' => 'control-label']) ?>
        <?= Html::dropDownList('options[class_css]', (isset($options['class_css'])?$options['class_css']:'col-md-3'), [
            'col-md-1' => '12',
            'col-md-2' => '6',
            'col-md-3' => '4',
            'col-md-4' => '3',
    ...
    <div class="col-md-3 sdbox-col">
        <?= Html::label(Yii::t('ezform', 'Style (css)'), 'options[style]', ['class' => 'control-label']) ?>
        <?= Html::textInput('options[style]', (isset($options['style'])?$options['style']:''), ['class'=>'form-control'])?>
    </div>
    <div class="col-md-3 sdbox-col">
        <?= Html::label(Yii::t('ezform', 'Placeholder'), 'options[placeholder]', ['class' => 'control-label']) ?>
        <?= Html::textInput('options[placeholder]', (isset($options['placeholder'])?$options['placeholder']:''), ['class'=>'form-control'])?>
    </div>
  </div>  

  <div class="form-group row">
    <div class="col-md-12">
        <?= Html::label(Yii::t('ezform', 'Layout'), 'options[layout]', ['class' => 'control-label']) ?>
        <?= Html::textInput('options[layout]', (isset($options['layout'])?$options['layout']:''), ['class'=>'form-control'])?>
    </div>
  </div> 
