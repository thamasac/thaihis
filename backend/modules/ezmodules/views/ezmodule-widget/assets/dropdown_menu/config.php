...
<div class="form-group row">
  ...
  <div class="col-md-6 sdbox-col" >
		...
		"select2:unselect" => "function() { $('#var-text-box').html(''); image(0); key_id(0);}"
	    ]
        ]);
        ?>
    </div>
...
<div class="form-group row">
    <div class="col-md-12">
        <?= Html::label(Yii::t('ezform', 'Query Params (GET)'), 'options[query_params]', ['class' => 'control-label']) ?>
...
<div class="form-group row">
    ...
    <div class="col-md-3 ">
        <?= Html::label(Yii::t('ezform', 'Image Wigth'), 'options[image_wigth]', ['class' => 'control-label']) ?>
    ...
    <div class="col-md-3 sdbox-col">
        <?= Html::label(Yii::t('ezform', 'Image'), 'options[image]', ['class' => 'control-label']) ?>
      <?php
  ...
  <div class="form-group row">
        <div class="col-md-3">
            ...
            <div class="input-group">
                <?= Html::textInput('options[width]', (isset($options['width'])?$options['width']:'400'), ['class'=>'form-control', 'type'=>'number'])?>
                <span class="input-group-addon">px</span>
              </div>
        </div>
      <div class="col-md-3 sdbox-col">
        <?= Html::label(Yii::t('ezform', 'Alignment'), 'options[align]', ['class' => 'control-label']) ?>
        <?= Html::dropDownList('options[align]', (isset($options['align'])?$options['align']:''), [''=>'none', 'navbar-left'=>'Left', 'navbar-right'=>'Right'], ['class'=>'form-control'])?>
    </div>
    <div class="col-md-3 sdbox-col">
...
<?php
$media_image = '<ul><li class="{active}"><a href="{url}" class="media" ><div class="media-left">{image}</div><div class="media-body" ><h4 class="list-group-item-heading">HN {hn} CID {cid}</h4><div class="list-group-item-text"><div><strong>Name : </strong>{fname} {lname}</div><div>The default media displays a media object. </div></div></div></a></li></ul>';
$media = '<ul><li class="{active}"><a href="{url}" class="media" ><div class="media-body" ><h4 class="list-group-item-heading">HN {hn} CID {cid}</h4><div class="list-group-item-text"><div><strong>Name : </strong>{fname} {lname}</div><div>The default media displays a media object. </div></div></div></a></li></ul>';

?>
<div class="form-group">
    <?= Html::label(Yii::t('ezform', 'Template Content').' 
