...
<div class="form-group row">
    <div class="col-md-6 ">
        <?php
        $attrname_ezf_type_id = 'options[ezf_cat_id]';
        $value_ezf_type_id = isset($options['ezf_cat_id']) ? $options['ezf_cat_id'] : '';
        ?>
        <?= Html::label(Yii::t('ezform', 'Form EC Category'), $attrname_ezf_type_id, ['class' => 'control-label']) ?>
        <?php
        echo kartik\select2\Select2::widget([
            'name' => $attrname_ezf_type_id,
            'value' => $value_ezf_type_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form EC Category'), 'id' => 'config_ezf_type_id'],
    ...
    <div class="col-md-3 sdbox-col">
        <?php
        $attrname_type_field_label = 'options[cat_field_label]';
        $field_type_label = isset($options['cat_field_label'])? $options['cat_field_label'] : '';
        ?>
    ...
    <div class="col-md-3 sdbox-col">
        <?php
        $attrname_type_field_value = 'options[cat_field_value]';
        $field_type_value = isset($options['cat_field_value']) ? $options['cat_field_value'] : '';
        ?>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <?php
        $attrname_type_fields = 'options[cat_fields]';
        $value_type_fields_json = isset($options['cat_fields']) ?$options['cat_fields'] : '';
        ?>
...
<div class="form-group row">
    <div class="col-md-6 ">
        <?php
        $attrname_ezf_name_id = 'options[ezf_subcat_id]';
        $value_ezf_name_id = isset($options['ezf_subcat_id']) ? $options['ezf_subcat_id'] : '';
        ?>
        <?= Html::label(Yii::t('ezform', 'Form EC Sub-category Event'), $attrname_ezf_name_id, ['class' => 'control-label']) ?>
        <?php
        echo kartik\select2\Select2::widget([
            'name' => $attrname_ezf_name_id,
            'value' => $value_ezf_name_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form EC Sub-category Event'), 'id' => 'config_ezf_name_id'],
            'data' => ArrayHelper::map($itemsEzform, 'ezf_id', 'ezf_name'),
            'pluginOptions' => [
                'allowClear' => true
            ],
...
<div class="form-group row">-->
    ...
    <div class="col-md-6">
        <?php
        $attrname_name_fields = 'options[subcat_fields]';
        $value_name_fields_json = isset($options['subcat_fields']) && is_array($options['subcat_fields']) ? \appxq\sdii\utils\SDUtility::array2String($options['subcat_fields']) : '{}';
...
<div class="form-group row">
    <div class="col-md-6 ">
        <?php
        $attrname_ezf_detail_id = 'options[ezf_event_id]';
        $value_ezf_detail_id = isset($options['ezf_event_id']) ? $options['ezf_event_id'] : '';
        ?>
        <?= Html::label(Yii::t('ezform', 'Form EC Event'), $attrname_ezf_detail_id, ['class' => 'control-label']) ?>
        <?php
        echo kartik\select2\Select2::widget([
            'name' => $attrname_ezf_detail_id,
            'value' => $value_ezf_detail_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form EC Event'), 'id' => 'config_ezf_detail_id'],
            'data' => ArrayHelper::map($itemsEzform, 'ezf_id', 'ezf_name'),
            'pluginOptions' => [
                'allowClear' => true
            ],
...
<!--    <div class="col-md-6 sdbox-col" >
        ...
        ?>
        <?php // echo Html::label(Yii::t('ezform', 'Field Version'), $attrname_ref_form_detail, ['class' => 'control-label']) ?>
...
<div class="form-group row">
    ...
    <div class="col-md-6">
        <?php
        $attrname_detail_fields = 'options[event_fields]';
        $value_detail_fields_json = isset($options['event_fields']) && is_array($options['event_fields']) ? \appxq\sdii\utils\SDUtility::array2String($options['event_fields']) : '{}';
        ?>
