...
if (is_array($conditions) && $act != 'addNew') :
    ...
    <div class="form-group row" id="content-condition<?= $sub_index ?>">
      <div class="col-md-5">
        ...
        <div id="ref_field<?= $sub_index ?>_box">
    ...
    <div class="form-group row" id="content-condition<?= $sub_index ?>">
      <div class="col-md-5">
          <?php
          $attrname_fields = 'options[items][' . $key_index . '][conditions][' . $sub_index . '][field]';
          $value_fields = '';
          ?>
          <?= Html::label(Yii::t('ezform', 'Field'), $attrname_fields, ['class' => 'control-label']) ?>
        <div id="ref_field<?= $sub_index ?>_box">
      ...
      <div class="col-md-1 sdbox-col">
          <?php
          $attrname_operator = 'options[items][' . $key_index . '][conditions][' . $sub_index . '][operator]';
          $value_operator = '';
          ?>
          <?= Html::label(Yii::t('ezform', 'Operators'), $attrname_operator, ['class' => 'control-label']) ?>
          <?= Html::dropDownList($attrname_operator, $value_operator, $operatorItem, ['class' => 'form-control']) ?>
      ...
      <div class="col-md-5 sdbox-col">
          <?php
          $attrname_compare = 'options[items][' . $key_index . '][conditions][' . $sub_index . '][compare]';
          $value_compare = '';
          ?>
      ...
      <div class="col-md-1 sdbox-col" style="margin-top:25px;">
        <?= Html::button('<i class="fa fa-trash"></i>', ['class' => 'btn btn-danger', 'id' => 'btn-remove-item-condition' . $sub_index, 'data-key_index' => $sub_index]) ?>
      </div>
    </div>
<?php
endif;
...
<?= \appxq\sdii\helpers\SDNoty::show('"server error"', '"error"') ?>
    ...
    $(document).on('click', '[id^=btn-remove-item-condition]', function () {
