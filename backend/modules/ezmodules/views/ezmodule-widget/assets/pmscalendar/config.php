...
<div class="row" >
    <div class="col-md-4 " >
        <?php
        $attrname_maintask_ezf_id = "options[maintask_ezf_id]";
        $value_maintask_ezf_id = isset($options['maintask_ezf_id']) ? $options['maintask_ezf_id'] : '';
        echo Html::label(Yii::t('ezform', 'Main Task Form'), $attrname_maintask_ezf_id);
        echo kartik\select2\Select2::widget([
            'name' => $attrname_maintask_ezf_id,
            'value' => $value_maintask_ezf_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form'), 'id' => 'config_maintask_ezf_id', 'class' => 'form-input'],
    ...
    <div class="col-md-4 " >
        <?php
        $attrname_subtask_ezf_id = "options[subtask_ezf_id]";
        $value_subtask_ezf_id = isset($options['subtask_ezf_id']) ? $options['subtask_ezf_id'] : '';

        echo Html::label(Yii::t('ezform', 'Sub-Task Form'), $attrname_maintask_ezf_id);
        echo kartik\select2\Select2::widget([
            'name' => $attrname_subtask_ezf_id,
            'value' => $value_subtask_ezf_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form'), 'id' => 'config_subtask_ezf_id', 'class' => 'form-input'],
            'data' => ArrayHelper::map($itemsEzform, 'ezf_id', 'ezf_name'),
            'pluginOptions' => [
                'allowClear' => true
            ],
...
<div class="row" >
    <div class="col-md-4 " >
        ...
        echo Html::label(Yii::t('ezform', 'Task Response Form'), $attrname_response_ezf_id);
        echo kartik\select2\Select2::widget([
            'name' => $attrname_response_ezf_id,
            'value' => $value_response_ezf_id,
            'options' => ['placeholder' => Yii::t('ezform', 'Form'), 'id' => 'config_response_ezf_id', 'class' => 'form-input'],
            'data' => ArrayHelper::map($itemsEzform, 'ezf_id', 'ezf_name'),
            'pluginOptions' => [
                'allowClear' => true
            ],
    ...
    <div class="col-md-4 " >
        ...
        $attrname_response_actual_field = "options[response_actual_field]";
        $value_response_actual_field = isset($options['response_actual_field']) ? $options['response_actual_field'] : '';
        echo Html::label(Yii::t('ezform', 'Response actual date field'), $attrname_response_actual_field);
        ?>

        <div id="response_actual_field_box">
...
response_actual_field($('#config_response_ezf_id').val());
...
$('#config_response_ezf_id').on('change',function(){
    var ezf_id = $(this).val();
    response_actual_field(ezf_id);             
});
    
function response_actual_field(ezf_id){
    var value = '$value_response_actual_field';
    $.post('" . Url::to(['/ezforms2/target/get-fields']) . "',{ ezf_id: ezf_id, multiple:0, name: '{$attrname_response_actual_field}', value: value ,id:'config_response_actual_field'}
      ).done(function(result){
         $('#response_actual_field_box').html(result);
      }).fail(function(){
