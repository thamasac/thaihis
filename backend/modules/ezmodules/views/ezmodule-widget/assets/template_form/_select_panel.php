    ...
    <div class="panel panel-warning">
        <div class="panel-heading">
            <div class="sdbox-col">
                ...
                <?= Html::button("<i class='fa fa-plus'></i>", ['class' => 'btn btn-success pull-right', 'id' => 'btn-add-header-select' ]) ?>
            </div>
        </div>
        <div class="panel-body">
            ...
            <div class="sdbox-col" id="display-header-select">
                <?php
                if (isset($selects) && is_array($selects)):
                    foreach ($selects as $key => $val):
                        ...
                        echo $this->renderAjax('_select_form', [
...
<script>
    $('#btn-add-header-select<?= $key_index ?>').on('click', function () {
        ...
        console.log('sfsfsdf'+key_index);
        onLoadHeaderSelect<?= $key_index ?>(key_index,sub_index, 'addNew');
    });

    function onLoadHeaderSelect<?= $key_index ?>(key_index,index, act) {
