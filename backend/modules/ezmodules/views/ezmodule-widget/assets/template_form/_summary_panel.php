    ...
    <div class="panel panel-warning">
        <div class="panel-heading">
            <div class="sdbox-col">
                ...
                <?= Html::button("<i class='fa fa-plus'></i>", ['class' => 'btn btn-success pull-right', 'id' => 'btn-add-summary' . $key_index]) ?>
            </div>
        </div>
            ...
            <div class="sdbox-col" id="display-summary<?= $key_index ?>">
                ...
                if (isset($summarys) && is_array($summarys)):
                    foreach ($summarys as $key => $val):
                        ...
                        echo $this->renderAjax('_summary_form', [
...
<script>
    $('#btn-add-summary<?= $key_index ?>').on('click', function () {
        ...
        onLoadSummary<?= $key_index ?>(key_index,sub_index, 'addNew');
    });

    function onLoadSummary<?= $key_index ?>(key_index,index, act) {
