...
/**
 * Description of ForumBuilder
 *
 * @author appxq
 */
class ForumBuilder extends Component {
    private $options = [];
    private $object_id = 0;
    private $parent_id = 0;
    ...
    /**
     * @inheritdoc
     * @return CommunityBuilder the newly created [[ForumBuilder]] instance.
     */
    public static function Community() {
        return Yii::createObject(ForumBuilder::className());//, [get_called_class()]
    }
    ...
    public function buildCommunity($limit=20) {
        ...
        $url = Url::to(['/gantt/gantt-forum/community-pad',
    ...
    public function buildQueryTool($limit=20) {
        ...
        $url = Url::to(['/gantt/gantt-forum/query-pad',
                    'object_id' => $this->object_id,
                    'modal' => $this->modal,
                    'reloadDiv' => $this->reloadDiv,
                    'parent_id' => $this->parent_id,
