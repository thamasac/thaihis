...
/**
 * This is the model class for table "gantt forum".
 *
 * @property integer $id
 ...
 */
class GanttForum extends \yii\db\ActiveRecord
{
    public $user_name;
	...
	return [
	    ...
	    'value_old' => Yii::t('ezform', 'Value Old'),
	    'value_new' => Yii::t('ezform', 'Value New'),
	    'approv_by' => Yii::t('ezform', 'Approv By'),
	    'approv_date' => Yii::t('ezform', 'Approv Date'),
	    'approv_status' => Yii::t('ezform', 'Approv Status'),
