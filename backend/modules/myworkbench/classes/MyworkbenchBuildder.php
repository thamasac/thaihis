...
namespace backend\modules\myworkbench\classes;
...
class MyworkbenchBuildder extends Component {
     //put your code her
    public $widget_id = '';
    public $reloadDiv = '';
    public $options = [];
    ...
    /**
     * @inheritdoc
     * @return MyworkbenchBuildder the newly created [[MyworkbenchBuildder]] instance.
     */
    public static function ui() {
        return Yii::createObject(MyworkbenchBuildder::className()); //, [get_called_class()]
    }

    public function buildMyworkbench() {
        if ($this->reloadDiv == '') {
            $this->reloadDiv = 'div-' . Yii::$app->uniqueId;
        }
        
        if($this->action == ''){
            $this->action = '/myworkbench/myworkbench/index';
        }
