...
<div id="ezf-search" style="padding: 5px;">  
    ...
    $form = ActiveForm::begin([
                ...
                'action' => ['/patient/calendar/appoin-report'],
                'method' => 'POST',
  ...
  <div class="form-group">
    ...
    <div class="col-md-1">
      ...
      <?=
      Html::a('Search', Url::to(['/patient/calendar/appoin-grid',]), ['id'=>'search-form-appoin', 'class' => 'form-control btn btn-success'
          , 'data-action' => 'search']);
      ?>
    </div>
  </div>
...
setTimeout(function(){ $('#search-form-appoin').trigger('click'); }, 1);
