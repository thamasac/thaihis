...
<div class="ordercounter-search col-md-12">
    ...
    $form = ActiveForm::begin([
                'id' => $model->formName(),
                'action' => ['/patient/order/order-counter-outlab'],
                'method' => 'get',
...
//                'enableClientValidation' => false,
  ...
  <div class="col-md-4" style="padding-left: 0px;padding-right: 0px;">
      <?= Html::activeRadioList($model, 'order_tran_status', ['1' => 'รับแล้ว', '2' => 'ออกผล'], ['class' => 'pull-left', 'itemOptions' => ['class' => 'radio-inline']]); ?>
  </div>
  <div class="col-md-3 sdbox-col">
      <?php
      if ($model['order_tran_status'] == '3') {
