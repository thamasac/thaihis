<?php
$url = \yii\helpers\Url::to(['/patient/order/order-receive-submit', 'ezf_id' => $ezf_id, 'target' => $visit_id
            , 'order_status' => $order_status, 'pt_id' => $data[0]['ptid'], 'dept' => $dept]);
$doctor_id = ''
?>
<div class="card card-cpoe">
  <div class="card-header">
    ...
    <!--<div class="col-md-6">-->
    <i class="fa fa-user"></i> <?= Yii::t('patient', 'Personal information') ?> 
    <!--</div>-->
  ...
  <div class="card-block" style="padding:0px">
    <div class="col-md-2" style="padding: 5px 5px">
        <?php
        echo backend\modules\patient\classes\PatientHelper::uiPatientPic($data[0]['ptid'], 'order-pt-pic', []);
        ?>
    </div>
    <div class="col-md-10">
        <?php
        echo backend\modules\patient\classes\PatientHelper::uiPatientCpoe($data[0]['ptid'], 'order-pt-show', null, TRUE);
        ?>
    </div>           
  </div>
</div>
              ...
              foreach ($data as $index => $value) {
                ...
                <tr>
                  ...
                  <td>
                      <?php
                      $initdata = [];
                      if ($value['ezf_id'] && $order_status <> '1') {
                          if ($dept == 'C') {
