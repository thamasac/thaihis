...
$urlSelect = yii\helpers\Url::to(['/ezforms2/ezform-data/ezform', 'ezf_id' => $ezfOrderTran_id, 'target' => $order_id,
            'modal' => "modal-grid-{$ezfOrderTran_id}", 'reloadDiv' => 'pis-item-order', 'initdata' => $initdata]);
...
?>
<div class="list-group-item" data-tmt="<?= $model['trad_tmt'] ?>" data-allergy="<?= $model['item_allergy_id'] ?>"
     data-url="<?= $urlSelect ?>" data-modal="modal-grid-<?= $ezfOrderTran_id ?>">
