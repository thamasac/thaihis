...
class CusQuery {
    ...
    public static function getDetailItemCheckup($hn, $visit_date, $right_code, $project_id) {
        ...
        $sql = "SELECT DATE(visit_date) AS visit_date,pt_hn,fullname,vpp.pt_bdate,zr.right_name
                ,zrt.tran_item_pay AS sumpay,zrt.tran_item_notpay AS sumnotpay
                ,co.sks_code,co.order_name,co.fin_item_code,fin_item_group_code,zpj.project_name
...
INNER JOIN const_order_finname cof ON(cof.fin_item_code=dkm4.drugtran_item_code_op)
    ...
    public static function getDetailItem($hn, $visit_date, $right_code) {
        ...
        $sql = "SELECT DISTINCT DATE(visit_date) AS visit_date,vpp.pt_hn,fullname,zr.right_name,pt_bdate
                ,zrt.tran_item_pay AS sumpay,zrt.tran_item_notpay AS sumnotpay
                ,co.sks_code,co.order_name,co.fin_item_code,fin_item_group_code,co.order_code,vpp.pt_cid
