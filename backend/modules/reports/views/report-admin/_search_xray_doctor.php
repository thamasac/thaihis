...
<div id="ezf-search" style="padding: 5px;">  
    ...
    $form = ActiveForm::begin([
                ...
                'action' => ['/reports/report-admin/report-xray-doctor-grid'],
                'method' => 'POST',
  ...
  <div class="form-group">
    ...
    <div class="col-md-1">
      ...
      <?=
      Html::a('Search', Url::to(['/reports/report-admin/report-xray-doctor-grid',]), ['class' => 'form-control btn btn-success'
          , 'data-action' => 'search']);
      ?>
    </div>
  </div>
