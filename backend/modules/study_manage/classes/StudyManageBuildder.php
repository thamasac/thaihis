...
class StudyManageBuildder extends Component {
     //put your code her
    public $widget_id = '';
    public $reloadDiv = '';
    public $options = [];
    ...
    /**
     * @inheritdoc
     * @return StudyManageBuildder the newly created [[StudyManageBuildder]] instance.
     */
    public static function ui() {
        return Yii::createObject(StudyManageBuildder::className()); //, [get_called_class()]
    }

    public function buildStudyManage() {
        if ($this->reloadDiv == '') {
            $this->reloadDiv = 'div-' . Yii::$app->uniqueId;
        }
        
        if($this->action == ''){
            $this->action = '/study_manage/default/index';
        }
