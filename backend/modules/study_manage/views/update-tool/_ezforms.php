...
$column = [
    ...
    [
        'header' => 'Action',
        'value' => function ($data) {
            return Html::button('Updated history', ['class' => 'btn btn-info btn_update_history', 'data-ezf_id' => $data['ezf_id'], 'data-pjax' => 'w0']).' '.Html::button('Start to update', ['class' => 'btn btn-success btn_start_update', 'data-ezf_id' => $data['ezf_id'], 'data-ezf_version' => $data['ezf_version'], 'data-pjax' => 'w0']);
        },
        'format' => 'raw',
        'headerOptions' => ['style' => 'text-align: center;', 'width' => '20%'],
        'contentOptions' => ['style' => 'width:40px; text-align: center;'],
