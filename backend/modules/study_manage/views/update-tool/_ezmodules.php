...
$column = [
    ...
    [
        ...
        'value' => function ($data) {
            $update_log = backend\modules\study_manage\classes\UpdateQuery::getLatestDate($data['ezm_id']);
            return \backend\modules\subjects\classes\JKDate::convertDateTime($update_log['latestDate'],'full') ;
        },
        'format' => 'raw',
        'headerOptions' => ['style' => 'text-align: center;', 'width' => '20%'],
        'contentOptions' => ['style' => 'width:40px; text-align: left;'],
    ...
    [
        'header' => 'Action',
        'value' => function ($data) {
            return Html::button('Updated history', ['class' => 'btn btn-info btn_update_history', 'data-ezf_id' => $data['ezm_id'], 'data-pjax' => 'w0']).' '.Html::button('Start to update', ['class' => 'btn btn-success btn_start_update_module', 'data-ezm_id' => $data['ezm_id'], 'data-pjax' => 'w0']);
        },
        'format' => 'raw',
        'headerOptions' => ['style' => 'text-align: center;', 'width' => '20%'],
        'contentOptions' => ['style' => 'width:40px; text-align: center;'],
