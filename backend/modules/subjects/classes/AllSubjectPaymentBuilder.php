...
/**
 * Description of AllSubjectPaymentBuilder
 *
 */
class AllSubjectPaymentBuilder extends Component {
    ...
    /**
     * @inheritdoc
     * @return AllSubjectPaymentBuilder the newly created [[AllSubjectPaymentBuilder]] instance.
     */
    public static function ui() {
        return Yii::createObject(AllSubjectPaymentBuilder::className()); //, [get_called_class()]
    }

    public function buildAllSubjectPayment() {
        if ($this->reloadDiv == '') {
            $this->reloadDiv = 'div-' . Yii::$app->uniqueId;
        }

        $view = \Yii::$app->getView();
        $url = Url::to(['/subjects/subject-management/all-subject-payment',
        ...
        if (is_array($options)) {
            $options['action'] = 'all-subject-payment';
