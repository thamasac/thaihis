...
/**
 * Description of ContainerWidgetBuilder
 *
 * @author appxq
 */
class ContainerWidgetBuilder extends Component {
    ...
    public static function contentBuilding() {
        return Yii::createObject(ContainerWidgetBuilder::className()); //, [get_called_class()]
    }
    ...
    public function buildContainer() {
        ...
        $url = Url::to(['/thaihis/container-widget/index',
                    'modal' => $this->modal,
