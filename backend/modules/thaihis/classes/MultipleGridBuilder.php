...
/**
 * Description of GridMultipleBuilder
 *
 * @author appxq
 */
class MultipleGridBuilder extends Component {
    ...
    /**
     * @inheritdoc
     * @return MultipleGridBuilder the newly created [[MultipleGridBuilder]] instance.
     */
    public static function gridDisplay() {
        return Yii::createObject(MultipleGridBuilder::className());//, [get_called_class()]
    }
    ...
    public function buildGrid() {
       if(empty($this->reloadDiv)){
        ...
        $url = Url::to(['/thaihis/multiple-grid/index',
                    'ezf_id' => $this->ezf_id,
                    'modal' => $this->modal,
