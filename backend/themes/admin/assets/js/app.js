...
var App = function () {
	...
	var renderToggleButton = function () {
	    $('#main-nav-app .navbar-header').prepend('<button id="sidebar-toggle-button" style="margin-left:0;margin-right:0;" type="button" class="navbar-brand" data-toggle="collapse" data-target="#slide-collapse">'+
