        ...
        <div class="col-xs-3 col-md-2" style="margin-bottom: 20px;">
            <div class="media-left">
                ...
                <?php else:?>
                    <a href="<?= $linkModule ?>">
                <?php endif;?>
                      <div style="margin: 4px;"><img src="<?= (isset($data['ezm_icon']) && $data['ezm_icon'] != '') ? Yii::getAlias('@storageUrl/module'). '/' . $data['ezm_icon'] : ModuleFunc::getNoIconModule() ?>" class="img-rounded" width="72" height="72"></div>
                </a>
