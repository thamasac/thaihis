    ...
    e.m = t, e.c = i, e.d = function (t, i, n) {
                    ...
                    return n(e, t), e.prototype.destructor = function () {
                        ...
                        if (this.$root && !this._resizeInProgress && (this.callEvent("onBeforeResize", []), i = !0, this._resizeInProgress = !0), t.prototype.resize.call(this, !0), t.prototype.resize.call(this, !1), i) {
                            ...
                            for (var r = 0; r < n.length; r++)
                                n[r].$config.hidden || n[r].setContentSize();
                            var a = !1;
                            if (this.$config.autosize)
                                a = !0, this.autosize(this.$config.autosize);
                            else
                                for (var r = 0; r < n.length; r++)
                                    n[r].$content && "scroller" == n[r].$content.$name && (n[r].$content.shouldHide() ? (n[r].hide(), a = !0) : n[r].$content.shouldShow() && (n[r].show(), a = !0));
                            if (a) {
                                this.resize();
                                for (var r = 0; r < n.length; r++)
                                    n[r].$config.hidden || n[r].setContentSize()
                        ...
                        for (var t, e, i, n = 0, r = 0, a = 0; a < this.$cells.length; a++)
                            e = this.$cells[a], e.$config.hidden || (t = e.getContentSize(), "scrollbar" === e.$config.view && (t.height = 0, t.width = 0), e.$config.resizer && (this._xLayout ? t.height = 0 : t.width = 0), i = e._getBorderSizes(), this._xLayout ? (n += t.width + i.horizontal, r = Math.max(r, t.height + i.vertical)) : (n = Math.max(n, t.width + i.horizontal), r += t.height + i.vertical));
            ...
            return {
                ...
                prepareConfigs: function (t, e, i, n, r, a) {
                    ...
                    for (var d = 0; d < l.length - 1; d++)
                        this.alineScaleColumns(l[l.length - 1], l[d]);
                    for (var d = 0; d < l.length; d++)
                        this.setPosSettings(l[d]);
                    return l
                },
        ...
        s.prototype = {
            _parseInner: function (t) {
                for (var e = null, i = [], n = 0, r = t.length; n < r; n++)
                    e = t[n], this.$initItem && (e = this.$initItem(e)), this.callEvent("onItemLoading", [e]) && (this.pull[e.id] = e, this.fullOrder.push(e.id), i.push(e));
                return i
            },
            parse: function (t) {
            ...
            updateItem: function (t, e) {
                if (r.defined(e) || (e = this.getItem(t)), !this._skip_refresh && !1 === this.callEvent("onBeforeUpdate", [t, e]))
                    return !1;
            ...
            removeItem: function (t) {
                ...
                if (!this._skip_refresh && !1 === this.callEvent("onBeforeDelete", [t, e]))
                    return !1;
            ...
            getItems: function () {
                for (var t = [], e = 0; e < this.fullOrder.length; e++)
                    t.push(this.pull[this.fullOrder[e]]);
                return t
            },
                ...
                traceDragEvents: function (t, e) {
                    var i = r.bind(function (i) {
                        return this.dragMove(t, i, e.accessor)
                            ...
                            s = r.bind(function (i) {
                                return r.eventRemove(document.body, e.move, n), r.eventRemove(document.body, e.up, s), this.dragEnd(t, i)
                            }, this);
        ...
        var n = i(1),
                r = function (t) {
                    return function (e) {
                        ...
                        function n(t, e, i, n) {
                            ...
                            if (r)
                                for (var a = 0; a < r.length; a++)
                                    i && i == r[a].root != i || r[a].handler.apply(this, n)
                        }
                        ...
                        function d(t, e, i, n) {
                            if (h[t])
                                for (var r = 0; r < h[t].length; r++)
                                    h[t][r].root == n && (h[t].splice(r, 1), r--)
                        }

                        function c(t) {
                            for (var i = 0; i < u.length; i++)
                                e.eventRemove(u[i][0], u[i][1], u[i][2]);
                            if (u = [], t) {
                                u.push([t, "click", r]), u.push([t, "dblclick", o]), u.push([t, "mousemove", l]), u.push([t, "contextmenu", a]);
                                for (var i = 0; i < u.length; i++)
                                    e.event(u[i][0], u[i][1], u[i][2])
                            }
                        }
                        var h = {
                            click: {},
        ...
        var n = i(5),
                ...
                l = function (t) {
                    ...
                    return n(e, t), e.prototype.init = function (t) {
                        ...
                        var t = 0;
                        if (this._isVertical()) {
                            for (var e = null, i = this.$parent.$parent.getCells(), n = 0; n < i.length; n++)
                                this.$parent === i[n] && (e = i[n - 1]);
        ...
        d.prototype = {
            ...
            columnIndexByDate: function (t) {
                ...
                if (e >= a.max_date)
                    return i.length;
                for (var s = n(i, e), o = +this._tasks.trace_x[s]; r[o]; )
                    o = this._tasks.trace_x[++s];
        ...
        o.prototype = {
            ...
            _setColumnsWidth: function (t) {
                for (var e = (this.$getConfig(), this.getGridColumns()), i = 0, n = t, r = 0, a = e.length; r < a; r++)
                    i += 1 * e[r].width;
                ...
                for (var c = o > 0 ? 1 : -1; o > 0 && 1 === c || o < 0 && -1 === c; ) {
                    ...
                    for (r = 0; r < s; r++) {
                        var t = e[r].width + c;
                        if ((e[r].min_width && t >= e[r].min_width || !e[r].min_width || l > e[r].width) && (o -= c, e[r].width = t, !o))
                            break
                    }
                    if (h == o)
                        break
            ...
            _calculateGridWidth: function () {
                ...
                if (t.autofit || n.length) {
                    ...
                    if (n.length > 0)
                        ...
                        for (var d = l / (r.length ? r.length : 1), a = 0; a < r.length; a++)
                            r[a] += d;
                    for (var a = 0; a < r.length; a++)
                        e[a].width = r[a]
                } else {
        ...
        function i(t) {
            ...
            function h(e, i, n, r) {
                var a = t.getState();
                +n.start_date >= +a.min_date && e.appendChild(r(i + " task_left")), +n.end_date <= +a.max_date && e.appendChild(r(i + " task_right"))
            }
            return e
        }
        t.exports = i
                    ...
                    a = {
                        ...
                        get_points: function (e, i) {
                            ...
                            var c = 2 * s.link_arrow_size,
                                    h = a.e_x > a.x;
                            if (e.type == n.links.start_to_start)
                                this.point_to(d.left, c), h ? (this.point_to(d.down, o), this.point_to(d.right, l)) : (this.point_to(d.right, l), this.point_to(d.down, o)), this.point_to(d.right, c);
                            else if (e.type == n.links.finish_to_start)
                                if (h = a.e_x > a.x + 2 * c, this.point_to(d.right, c), h)
                                    l -= c, this.point_to(d.down, o), this.point_to(d.right, l);
                                else {
                                    l -= 2 * c;
                                    var u = o > 0 ? 1 : -1;
                            ...
                            else if (e.type == n.links.finish_to_finish)
                                this.point_to(d.right, c), h ? (this.point_to(d.right, l), this.point_to(d.down, o)) : (this.point_to(d.down, o), this.point_to(d.right, l)), this.point_to(d.left, c);
                        ...
                        get_endpoint: function (e, i) {
                            var r = i.$getConfig(),
                                    ...
                                    s = !1,
                                    o = !1;
                            e.type == a.start_to_start ? s = o = !0 : e.type == a.finish_to_finish ? s = o = !1 : e.type == a.finish_to_start ? (s = !1, o = !0) : e.type == a.start_to_finish ? (s = !0, o = !1) : null;
            ...
            function e(e, i) {
                for (var n, a = i.getGridColumns(), s = i.$getConfig(), o = [], l = 0; l < a.length; l++) {
                    ...
                    if ("add" == _.name) {
                        ...
                        c = _.template ? _.template(e) : e[_.name], r.isDate(c) && (c = t.templates.date_grid(c, e)), h = c, c = "<div class='gantt_tree_content'>" + c + "</div>";
                    var f = "gantt_cell" + (u ? " gantt_last_cell" : ""),
                            p = "";
                    if (_.tree) {
                        for (var v = 0; v < e.$level; v++)
                            p += t.templates.grid_indent(e);
                            ...
                            initEvents: function (t, e) {
                                ...
                                this._eventHandlers.push(["click", "gantt_close", e.bind(function (t, e, i) {
                                        ...
                                        if (e.callEvent("onGridHeaderClick", [s, n])) {
                                            var o = t.$getConfig();
                                            if ("add" == s)
                                                return void i.callHandler("click", "gantt_add", void 0, [n, o.root_id]);
                                            if (o.sort) {
                                                ...
                                                if (l && void 0 !== l.sort && !0 !== l.sort && !(d = l.sort))
                                                    return;
                            ...
                            _attachGanttEvents: function (t) {
                                function e(t, e, i, n) {
                                    for (var r = 0; r < t.length; r++)
                                        t[r].change_id(e, i), t[r].render_item(n)
                                }
                        ...
                        if (e.isTaskExists(s) && (o = e.getTask(s)), !e.isReadonly(o) && !this.drag.mode) {
                            ...
                            if (d)
                                if (d.mode && d.mode != r.drag_mode.ignore && r["drag_" + d.mode]) {
                                    ...
                                    if (e.isSummaryTask(o) && d.mode != r.drag_mode.progress)
                ...
                on_mouse_up: function (i) {
                    ...
                    if (n.mode && n.id) {
                        ...
                        if (r.work_time && r.correct_work_time && this._fix_working_times(a, n), this._fix_dnd_scale_time(a, n), e._init_task_timing(a), this._fireEvent("before_finish", n.mode, [n.id, n.mode, e.copy(n.obj), i])) {
                            ...
                            this.clear_drag_state(), n.obj._dhx_changed = !1, e.mixin(a, n.obj, !0), e.refreshTask(a.id)
                    }
                    this.clear_drag_state()
                },
        ...
        var n = i(1),
                r = function (t, e) {
                    ...
                    function l(t) {
                        ...
                        i.link_source_id && i.link_target_id && (e.isLinkAllowed(i.link_source_id, i.link_target_id, i.link_from_start, i.link_to_start) ? n.push("gantt_allowed_link") : null);
                            ...
                            if (r && "resizer" == r.$name) {
                                ...
                                r.attachEvent("onResizeStart", function (e, i) {
                                    var n = t.$ui.getView("grid"),
                                            r = n ? n.$parent : null;
                                    if (r) {
                                        for (var s = 0, o = t.getGridColumns(), l = 0; l < o.length; l++)
                                            s += o[l].min_width ? o[l].min_width : t.config.min_grid_column_width;
                                        r.$config.minWidth = s
                                    }
                    ...
                    return {
                        ...
                        refreshTask: function (t, e) {
                            ...
                            if (i && this.isTaskVisible(t)) {
                                if (this.$data.tasksStore.refresh(t), void 0 !== e && !e)
                                    return;
                        ...
                        sort: function (t, e, i, n) {
                            ...
                            if (o) {
                                for (var l = [], d = o.length - 1; d >= 0; d--)
                                    l[d] = this.$data.tasksStore.getItem(o[d]);
                                l.sort(a);
                                for (var d = 0; d < l.length; d++)
                                    o[d] = l[d].id, this.sort(t, e, o[d], !0)
                            }
                            r && this.render()
                        },
                        clearAll: function () {
                ...
                r = function () {
                    return {
                        ...
                        getGlobalTaskIndex: function (t) {
                            return null;//this.assert(t, "Invalid argument"), this.$data.tasksStore.getIndexById(t)
                        },
        ...
        o.prototype = r.mixin({
            _buildTree: function (t) {
                for (var e = null, i = 0, n = t.length; i < n; i++)
                    e = t[i], this.setParent(e, this.getParent(e) || this.$rootId);
                for (var i = 0, n = t.length; i < n; i++)
                    e = t[i], this._add_branch(e), e.$level = this.calculateItemLevel(e)
            },
            parse: function (t) {
                this.callEvent("onBeforeParse", [t]);
                var e = this._parseInner(t);
                    ...
                    n = {
                        ...
                        renderItems: function (t) {
                            for (var e = t.getLayers(), n = 0; n < e.length; n++)
                                e[n].clear();
                            for (var r = i.getVisibleItems(), n = 0; n < e.length; n++)
                                e[n].render_items(r)
                        }
                    };
        ...
        t.exports = function (t) {
            for (var e = [i(62), i(63), i(64), i(65), i(66)], n = 0; n < e.length; n++)
                e[n] && e[n](t)
        }
    }, function (t, e, i) {
        var n = i(1);
        ...
        t.exports = function (t) {
            t.isUnscheduledTask = function (t) {
                ...
                if (!e)
                    return [];
                for (var i = e.$source.concat(e.$target), n = this.getChildren(e.id), r = 0; r < n.length; r++)
                    i = i.concat(this._getChildLinks(n[r]));
                for (var a = {}, r = 0; r < i.length; r++)
                    a[i[r]] = !0;
                i = [];
                for (var r in a)
                    this.isLinkExists(r) && i.push(r);
                return i
            }, t._getTaskTree = function (t) {
                var e = this.getTask(t);
                if (!e)
                    return [];
                for (var i = [], n = this.getChildren(e.id), r = 0; r < n.length; r++)
                    i.push(n[r]), i = i.concat(this._getTaskTree(n[r]));
                return i
                ...
                for (var a = 0; a < t.length; a++)
                    i && (this._dp.setGanttMode("links"), this._dp.setUpdated(t[a], !0, "deleted"));
                this.$data.linksStore.silent(function () {
                    for (var e = 0; e < t.length; e++)
                        this.$data.linksStore.removeItem(t[e])
                ...
                var i, r, a, s = e.date,
                        o = e.step,
                        l = e.unit;
                if (l == t.getScale().unit && o == t.getScale().step && +s >= +t._min_date && +s <= +t._max_date)
                    a = Math.floor(t.columnIndexByDate(s)), t.getScale().trace_x[a] || (a -= 1), r = new Date(t.getScale().trace_x[a]), i = new Date(r), i = t.getScale().trace_x[a + 1] ? new Date(t.getScale().trace_x[a + 1]) : t.date.add(r, o, l);
                else {
                    ...
                    if (n.getAttribute("dhx_button"))
                        ...
                        if (-1 != o.indexOf("gantt_custom_button"))
                            if (-1 != o.indexOf("gantt_custom_button_"))
                                for (r = n.parentNode.getAttribute("index"), s = n; s && - 1 == e.getClassName(s).indexOf("gantt_cal_lsection"); )
                                    s = s.parentNode;
                            else
                                r = n.getAttribute("index"), s = n.parentNode, n = n.firstChild;
...
//            e.id && (t._lightbox_id = e.id)
                    ...
                    for (var l = "", d = 0; d < n.length; d++) {
                        ...
                        switch (c) {
                            ...
                            case "%H:%i":
                                ...
                                var p = o,
                                        v = a.getDate();
                                for (e._time_values = []; p < s; )
                                    h += "<option value='" + p + "'>" + this.templates.time_picker(a) + "</option>", e._time_values.push(p), a.setTime(a.valueOf() + 60 * this._get_timepicker_step() * 1e3), p = 24 * (a.getDate() != v ? 1 : 0) * 60 + 60 * a.getHours() + a.getMinutes()
                        }
                        if (h) {
        ...
        t.exports = function (t) {
            ...
            for (var i = ["message", "alert", "confirm", "modalbox", "uid", "copy", "mixin", "defined", "bind", "assert"], n = 0; n < i.length; n++)
                window.dhtmlx[i[n]] || (dhtmlx[i[n]] = function (i) {
                    return function () {
