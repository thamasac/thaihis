    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading" style="position: relative;">
                <h3 class="panel-title"><?= Yii::t('rbac-admin', 'Permission')?></h3>
                <div class="panel-tools">
                    <button ng-if="!isEdit" class="btn btn-default btn-sm" ng-click="clickEdit()"><span class="fa fa-pencil"></span></button>
                    <button ng-if="!isEdit" class="btn btn-default btn-sm" ng-click="clickDelete()"><span class="fa fa-trash"></span></button>
                    <button ng-if="!!isEdit" class="btn btn-default btn-sm" ng-click="clickSave()"><span class="fa fa-save"></span></button>
                    <button ng-if="!!isEdit" class="btn btn-default btn-sm" ng-click="clickCancel()"><span class="fa fa-times-circle-o"></span></button>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
...
<div class="row">
    <div class="col-md-6">
        <div class="panel panel-success">
            <div class="panel-heading" style="position: relative;">
                <h3 class="panel-title"><?= Yii::t('rbac-admin', 'Children')?>:</h3>
                <div class="panel-tools">
    ...
    <div class="col-md-6 sdbox-col">
        <div class="panel panel-success">
            <div class="panel-heading" style="position: relative;">
                <h3 class="panel-title"><?= Yii::t('rbac-admin', 'Avaliable')?>:</h3>
                <div class="panel-tools">
                    <div class="has-feedback">
                        <input type="text" class="form-control input-sm"
